            ...
            {ex.serie.map((s,si)=>(
              <div key={si}>
                <div className="set-r">
                  ...
                  <div><input className="sinp" type="number" min="0" step="0.5" placeholder="—" value={s.kg} onChange={e=>updSet(ei,si,"kg",e.target.value)} disabled={s.completata}/></div>
                  <div><input className="sinp" type="text" placeholder={s.reps} value={s.reps} onChange={e=>updSet(ei,si,"reps",e.target.value)} disabled={s.completata}/></div>
